...
const Promobulan = () => {
  return (
    <div>
      <h1 className=" justify-center text-center font-bold text-[300px]" style={{ color: '#4784A8', fontSize: '24pt', fontWeight: 'bold', marginTop: '200px', marginBottom: '100px'}}>Dapatkan Promo Bulan Ini!</h1>
      <Carousel>
        <Carousel.Item>
