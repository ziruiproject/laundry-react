  ...
  return (
    ...
    <div id='Home' className='h-auto px-10 lg:px-[200px] flex items-center'>
      <div className="h-screen max-w-[700px] flex flex-col justify-center gap-y-5">
        ...
        <h1 className="font-bold text-5xl transition-property: all; transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);transition-duration: 150ms;" style={{ color: '#4784A8' }}>Laundry Berkualitas Hidup Tanpa Beban</h1>
